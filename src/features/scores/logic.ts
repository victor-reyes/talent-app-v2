...
export const calculateCategoriesScores = (developerScore: DeveloperScore) => {
    const programmingScore = (developerScore.frontend + developerScore.backend) / 2;
    const planningScore = (developerScore.management + developerScore.design) / 2;
    const communicationScore = (developerScore.individualCommunication + developerScore.teamCollaboration) / 2;
